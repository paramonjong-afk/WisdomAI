...
function flowNodes(row: AdvanceCase): FlowNode[] {
  ...
  const remarkNode: FlowNode = { key: 'reconciliation', label: 'Remark กระทบยอดเงินเข้า', status: 'missing', time: null, owner: 'Flow กลาง / ยังไม่ระบุ', documentId, audit: audits, detail: 'ต้องบันทึกผ่าน Flow กลางของรายการ ไม่ใช้ข้อมูลในเครื่อง' }
  return [
