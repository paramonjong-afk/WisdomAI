...
const systemFlows = [
  ...
  },
  {
    ...
    version: 'Launcher v1.3 · 22/8/2569',
    icon: <AppsOutlinedIcon color="primary" />,
    summary: 'จุดเข้าโปรแกรมด้านนอกสุดหลัง Login และจุดเริ่มต้นของไอคอน WisdomAI เดียวบนมือถือ มี Web Chat พร้อมจำนวนข้อความที่ยังไม่ได้อ่าน และไอคอนลงเวลา',
    bullets: ['อ่านจาก docs/NAVIGATION_FLOW.md', 'PWA ใช้ไอคอนแบรนด์เดียวขนาด 192/512 และเปิดเข้า `/` ก่อนเลือกเมนู', 'Web Chat badge รวมข้อความค้างทุกห้องของบริษัทปัจจุบัน', 'หากอ่านจำนวนไม่ได้ยังเปิดเข้า Web Chat/ลงเวลาได้ และระบบ retry อัตโนมัติ'],
    path: '/',
    action: 'ไปหน้าเลือกเมนู',
  },
  {
    ...
    bullets: ['อ่านจาก docs/OMNI_CHANNEL_INTAKE_OUTTAKE_FLOW.md', 'ค่า default โหลดวันนี้/รายการรอ Filter เพื่อลดภาระหน้าใหญ่', 'งานภายในใช้ Web Chat/Queue เป็นหลัก ส่วน LINE ใช้คนนอกหรือแจ้งเตือนสั้นตาม Config'],
    path: '/document-flows',
  ...
  },
  {
    ...
    version: 'HR Chat Stream v2.6 · 22/8/2569',
    icon: <ChatBubbleOutlineOutlinedIcon color="primary" />,
