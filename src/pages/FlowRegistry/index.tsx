...
const systemFlows = [
  ...
  },
  {
    ...
    version: 'HR Chat Stream v3.4 · Attachment v3.0 · 31/8/2569',
    icon: <ChatBubbleOutlineOutlinedIcon color="primary" />,
