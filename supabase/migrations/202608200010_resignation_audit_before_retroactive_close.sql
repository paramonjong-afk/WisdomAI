...
begin
  ...
  if access_ends_on <= target_last_working_on then raise exception 'วันที่ตัดสิทธิ์ต้องเป็นวันถัดจากวันสุดท้ายทำงานหรือหลังจากนั้น'; end if;
  ...
  set ends_on=greatest(target_last_working_on, starts_on),
