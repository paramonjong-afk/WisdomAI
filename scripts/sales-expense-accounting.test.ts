...
assert.match(migration, /sales_expense_existing_accounting_draft_requires_review/)
assert.doesNotMatch(migration, /delete from public\.accounting_draft_entries/i)
...
assert.match(registry, /Sales Expense Accounting v1\.1/)
...
assert.match(runtimeSql, /runtime_existing_draft_guard_failed/)
assert.match(runtimeSql, /runtime_existing_draft_was_modified/)
