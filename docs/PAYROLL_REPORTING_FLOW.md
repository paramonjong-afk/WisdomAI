...
| v1.1 | 26/8/2569 | ให้ค่าแรงจากสลิปมีเส้นทางตรวจสอบกลับถึงกองเงินและส่ง HR เป็นงานรอตรวจ โดยไม่สร้าง Payroll อัตโนมัติ | Accounting Allocation → HR destination task และ Root/Parent Lineage | `20260825231054_transfer_slip_money_allocations_v2.sql` | money allocation contract, task idempotency, lint/typecheck/build และ HR queue smoke | ปิด v2 routing; Payroll/Attendance เดิมไม่ถูกแก้หรือลบ |
