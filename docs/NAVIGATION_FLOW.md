...
| v1.14 | 4/9/2569 | Add an explicit 44px close action to the mobile navigation Drawer after authenticated Production smoke found that backdrop/Escape were the only close paths | mobile responsive contract, targeted lint, typecheck, build and authenticated mobile Drawer smoke | remove the close IconButton; Drawer content, routes and permissions remain unchanged |
